      ...
      <div className="mt-10 flex justify-center items-center border h-screen bg-[url('/images/abc.jpg')] object-contain bg-no-repeat bg-cover">
        <center>
          ...
          <div className="space-x-4">
            <button
              className="px-2 py-2 bg-green-500 rounded-2xl text-white hover:bg-blue-600 w-36"
              type="submit"
            ...
            <button
              className="px-2 py-2 bg-yellow-500 rounded-2xl text-white hover:bg-neutral-800 w-36"
              type="submit"
